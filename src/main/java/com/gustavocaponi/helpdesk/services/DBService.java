...
import com.gustavocaponi.helpdesk.repositories.ChamadoRepository;
...
import com.gustavocaponi.helpdesk.domain.enums.Perfil;
import com.gustavocaponi.helpdesk.domain.enums.Prioridade;
import com.gustavocaponi.helpdesk.domain.enums.Status;
...
public class DBService {
	...
	public void instanciaDB() {
		...
		Tecnico tec6 = new Tecnico(null, "Gustavo Caponi", "831.445.350-10", "gustavo@mail.com", encoder.encode("123"));
		tec1.addPerfil(Perfil.ADMIN);
